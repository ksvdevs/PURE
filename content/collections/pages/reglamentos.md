                                ...
                                <tr data-type="{{ reglamento_o_base }}" data-year="{{ anio }}">
                                    ...
                                    <td>
                                        <div class="reglamentos-cell-title">
                                            ...
                                            <span class="reglamentos-doc-meta" data-date="{{ if fecha_de_aprobacion }}{{ fecha_de_aprobacion }}{{ else }}{{ fecha_publicacion }}{{ /if }}">
                                                Publicado: {{ if fecha_de_aprobacion }}{{ fecha_de_aprobacion }}{{ else }}{{ fecha_publicacion }}{{ /if }}
                                            </span>
                                        </div>
                                    </td>
